...
using NimblePros.MediatRValidation.Core.ProjectAggregate;
using NimblePros.MediatRValidation.Core.Services;
using NimblePros.MediatRValidation.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace NimblePros.MediatRValidation.UnitTests.Core.Services
{
